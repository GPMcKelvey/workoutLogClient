...
const WorkoutIndex = (props) => {
    ...
    const fetchWorkouts = () => {
        fetch('http://localhost:4000/log/view', {
            method: 'GET',
            headers: new Headers ({
    ...
    return(
        <Container>
            <Row>
                ...
                {updateActive ? <WorkoutEdit workoutToUpdate={workoutToUpdate} updateOff={updateOff} fetchWorkouts={fetchWorkouts} token={props.token} /> : <></>}
            </Row>
        </Container>
    );
};
